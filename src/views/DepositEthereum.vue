...
export default {
    ...
    methods:{
        onChange(){
            axios.get(`/api/wallet/eth/rates?amount=${this.amount}`).then(res=>{
        ...
        createPayment(){
            ...
            axios.get(`/api/wallet/eth/create?amount=${this.amount}`).then(res=>{
                this.loading = false;
                ...
                if(res.data.error){
                    ...
                    this.paymentAmount = res.data.data.pay_amount + ' ETH';
                    this.payment = true;
                }
            })
        },
